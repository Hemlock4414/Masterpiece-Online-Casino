                ...
                <aside>
                    ...
                    <div class="sidebar">
                        ...
                        <ul class="sidebar-list">
                            <li><a class="sidebar-nav-link" href="#C1"><h3>Allgemeines</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C2"><h3>Beschreibung der Dienste</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C3"><h3>Registrierung des Spielerkontos</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C4"><h3>Kündigung des Spielerkontos</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C5"><h3>Kontosperrung</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C6"><h3>Verantwortungsvolles Spielen</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C7"><h3>Allgemeine Spielregeln</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C8"><h3>Datenschutz und Privatsphäre</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C9"><h3>Haftung</h3></a></li>
                            <li><a class="sidebar-nav-link" href="#C10"><h3>Geistiges Eigentum</h3></a></li>
                    ...
                    <div class="main-content">
                        ...
                        <section>
                            <h2 class="heading" id="C1">Allgemeines</h2>

                            <p>Sie dürfen nur über ein (1) Spielerkonto auf unserer Webseite verfügen. Sollten Sie versuchen mehr 
                            als ein Spielerkonto zu eröffnen, können sämtliche Spielerkonten von uns gesperrt werden. Besteht 
                            der begründete Verdacht, dass du über mehr als ein Konto verfügst, behalten wir uns vor, die 
                            ...
                            <p>
                            Mit der Nutzung unserer Webseite bestätigen Sie, dass Sie nicht in betrügerischer Absicht handeln, 
                            keine Absprachen mit anderen Spielern treffen, keine sonstigen rechtswidrigen Aktivitäten 
                            vornehmen oder mit Dritten vornehmen werden und Sie unsere Spiele nicht mit hard- oder 
                            softwaregestützten Methoden manipulieren. Im Falle eines Verstosses können wir die in 
                        ...
                        <section>
                            <h2 class="heading" id="C2">Beschreibung der Dienste</h2>

                            <p>
                            Sie können an den auf unserer Webseite verfügbaren Geldspielen teilnehmen, indem Sie Geldbeträge 
                            einsetzen. Auf unsere Webseite  können Sie mithilfe von Desktopgeräten zugreifen und, sofern 
                            anwendbar, mithilfe von Mobiltelefonen und Tablet-Computern. Die Mobilversion von dieser Webseite 
                            unterstützt möglicherweise nicht sämtliche Funktionen der Desktopversion.</p><br>
                            <p>
                            Wir behalten uns das Recht vor, die Anzahl und Art der auf der dieser Webseite
                            angebotenen Dienste basierend auf den Unternehmensanforderungen und/oder gesetzlichen 
                            Anforderungen gelegentlich zu erweitern, zu ändern oder zu beenden, wobei wir nicht 
                            verpflichtet sind, Sie darüber persönlich zu informieren oder Ihre Zustimmung einzuholen.</p><br>
                            <p>
                            Die auf unserer Webseite angebotenen Dienste und Spiele basieren auf modernster Technologie. 
                            Wir garantieren indessen keine unterbrechungsfreie Verfügbarkeit und vollständige 
                            Funktionalität sämtlicher Spiele und Dienste. Wir unternemhmen alle vertretbaren 
                            Bemühungen, erkannte Fehler, die auftreten können, zu beheben.</p><br>
                            <p>
                            Nicht Gegenstand dieser AGB sind Leistungen und Dienste, die nicht von uns erbracht 
                            werden, wie beispielsweise die Internet-Verbindung, die Software Dritter (z.B. 
                            PC-Betriebssysteme, Zugangssoftware, Webbrowser, App-Stores) oder Ihre eigene Hardware (PC, 
                            Tablet, Mobiltelefon etc.).</p><br>
                            <p>
                        ...
                        <section>
                            <h2 class="heading" id="C3">Registrierung des Spielerkontos</h2>
                            ...
                            Spielernamen, die auf bestimmte Rechte des Benutzers anspielen. Wir behalten 
                            uns das Recht vor, Konten mit einem inakzeptablen Spielernamen vorrübergehend zu sperren. 
                            Konten können reaktiviert werden, sobald eine geeignete und akzeptable Alternative gewählt wurde.</p><br>
                            <p>
                            Um ein Konto zu eröffnen, müssen Sie uns alle Ihre folgenden personenbezogenen Daten übermitteln:</p><br>
                            <ul>
                                <li>Vorname</li>
                                <li>Nachname</li>
                                <li>Geburtsdatum</li>
                            ...
                            <p>
                            Im Rahmen des Registrierungsvorgangs für Ihren nächsten Zugang (Login) auf der Webseite müssen Sie 
                            einen Spielernamen und ein Passwort wählen. Der Spielername sollte keine Rückschlüsse auf 
                            Ihre Identität zulassen, da dieser öffentlich und daher auch für Dritte ersichtlich ist.</p><br>
                            <p>
                        ...
                        <section>
                            ...
                            <h2 class="heading" id="C4">Kündigung des Spielerkontos</h2>
                        ...
                        <section>
                            <h2 class="heading" id="C5">Kontosperrung</h2>

                            <p>Wir behalten uns das Recht vor, die Registrierung auszusetzen, zu beenden und das Konto 
                            eines Spielers vorübergehend oder dauerhaft ohne Vorankündigung oder Entschädigung zu schliessen, 
                            auch während des Spiels, insbesondere in den folgenden Fällen:</p><br>

                            <ul>
                                <li>Wir gehen davon aus, dass der Spieler gegen eine oder mehrere Bestimmungen dieser AGB 
                                verstossen hat.</li>
                                
                                <li>Im Falle eines groben Fehlverhaltens gegenüber dem Kundendienst und weiteren Mitarbeitenden von 
                                uns oder damit verbundenen Unternehmen, namentlich jegliche drohenden, beleidigenden 
                        ...
                        <section>
                        <h2 class="heading" id="C6">Verantwortungsvolles Spielen</h2>

                            Bei uns steht ein positives und unterhaltsames Spielerlebnis im Vordergrund. Auf unserer 
                            ...
                            Spielverhaltens zur Verfügung.

                        </section>

                        <section>
                            <h2 class="heading" id="C7">Allgemeine Spielregeln</h2>
                            ...
                            allfälliger Gewinn dem Spielerkonto gutgeschrieben. Nach einem Spielunterbruch wird kein neues 
                            Spiel initiiert und kein weiterer Einsatz abgebucht.</p><br>

                            <p>Im Falle eines Softwarefehlers oder einer Funktionsstörung des Zufallsgenerators (RNG) ist das 
                            aktuelle Spiel nichtig. Wir behalten uns vor auch nachträglich Ergebnisse zu korrigieren 
                        ...
                        <section>
                            <h2 class="heading" id="C8">Datenschutz und Privatsphäre</h2>
                        ...
                        <section>
                            <h2 class="heading" id="C9">Haftung</h2>

                            <p>Wir übernehmen keinerlei Verantwortung und keinerlei Haftung für direkte 
                            oder indirekte Folgen, die Ihnen durch Gebrauch oder Missbrauch der Dienste von unserer Webseite 
                            durch Sie selbst oder durch Dritte erwachsen sind.</p><br>

                            <p>Wir erbringen unsere Dienste in der auf unserer Webseite dargestellten Form und ohne 
                            jegliche Gewährleistungen oder Zusagen in Bezug auf Marktfähigkeit oder Eignung für bestimmte 
                            Zwecke. Im gesetzlich maximal zulässigen Umfang schliessen wir ausdrücklich jegliche 
                        ...
                        <section>
                            <h2 class="heading" id="C10">Geistiges Eigentum</h2>

                            <p>Die Webseite sowie die gesamten darüber zugänglichen Inhalte sind urheberrechtlich geschützt und 
                            gehören, soweit nicht anders bestimmt, ausschliesslich und umfassend uns. Inhalte können 
                            Hinweise auf Schutz- und Nutzungsrecht von Dritten enthalten, die vom Nutzer zu beachten sind. 
                        ...
                        <section>
                            <h2 class="heading" id="C11">Laufzeit</h2>
                        ...
                        <section>
                            <h2 class="heading" id="C12">Fassung / Änderungen</h2>
                        ...
                        <section>
                            ...
                            <article>
                                ...
                                <h3 class="heading" id="C14">Allgemeine Informationen</h3>
                            ...
                            <article>
                                <h3 class="heading" id="C15">Was ist ein Cookie?</h3>
                            ...
                            <article>
                                ...
                                <h3 class="heading" id="C16">Was sind die Vorteile von Cookies?</h3>
                            ...
                            <article>
                                <h3 class="heading" id="C17">Welche Cookie-Typen verwenden wir?</h3>
                            ...
                            <article>
                                <h3 class="heading" id="C18">Unbedingt notwendige Cookies</h3>
                            ...
                            <article>
                                <h3 class="heading" id="C19">Cookie-Präferenzen einstellen</h3>
                            ...
                            <article>
                                <h3 class="heading" id="C20">Änderungen der Cookie-Richtlinien</h3>
