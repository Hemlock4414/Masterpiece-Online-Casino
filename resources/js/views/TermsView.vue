            ...
            <div class="page-content">
                ...
                <div class="content">
                    ...
                    <div class="main-content">
                        ...
                        <section id="C1">
                            <h2 class="heading">Allgemeines</h2>
                            ...
                            der begründete Verdacht, dass Sie über mehr als ein Konto verfügen, behalten wir uns vor, die 
                        ...
                        <section id="C2">
                            <h2 class="heading">Beschreibung der Dienste</h2>
                        ...
                        <section id="C5">
                            <h2 class="heading">Kontosperrung</h2>
                        ...
                        <section id="C10">
                            <h2 class="heading">Geistiges Eigentum</h2>
                        ...
                        <section id="C13">
                            <h2 class="heading">Cookie-Richtlinie</h2>
                            ...
                            <article id="C15">
                                <h3 class="heading">Was ist ein Cookie?</h3>
